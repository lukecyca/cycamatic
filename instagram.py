...
class InstagramSession(object):
    ...
    def login(self, username, password):
        ...
        r = self.session.post("https://instagram.com/api/v1/accounts/login/", payload, timeout=TIMEOUT)
        r_json = r.json()
        print r_json
    ...
    def upload_photo(self, filename):
        ...
        r = self.session.post("https://instagram.com/api/v1/media/upload/", data, files=files, timeout=TIMEOUT)
        print r.text
        r_json = r.json()
        print r_json
    ...
    def configure_photo(self, media_id, caption):
        ...
        r = self.session.post("https://instagram.com/api/v1/media/configure/", payload, timeout=TIMEOUT)
        r_json = r.json()
        print r_json
    ...
    def permalink(self, media_id):
        r = self.session.get("http://instagr.am/api/v1/media/{}/permalink/".format(media_id), timeout=TIMEOUT)
        return r.json()
